...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2025 a las 01:10:14
...
--
-- Estructura de tabla para la tabla `alumnosss`
--

CREATE TABLE `alumnosss` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `alumnosss`
--

INSERT INTO `alumnosss` (`id`, `nombre`, `apellido`, `num_control`, `fecha_nacimiento`, `genero`, `correo`, `telefono`) VALUES
(1, 'Jose David', 'Lopez Beltran', '23325061070435', '2008-01-18', 0, 'Jodav1818@gmail.com', '3112618228'),
...
--
-- Indices de la tabla `alumnosss`
--
ALTER TABLE `alumnosss`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `alumnosss`
--
ALTER TABLE `alumnosss`
